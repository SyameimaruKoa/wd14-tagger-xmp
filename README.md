...
- バッチ推論対応（動的バッチ）: `SmilingWolf/wd-v1-4-swinv2-tagger-v2`

迷ったら、デフォルトの `SmilingWolf/wd-v1-4-convnext-tagger-v2` を推奨じゃ。
...
| **項目名 (key)**            | **デフォルト値**                           | **説明**                                                                                                                                                                                                         |
| --------------------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `model_repo`                | `"SmilingWolf/wd-v1-4-convnext-tagger-v2"` | 使用するモデル/タグのリポジトリID。                                                                                                                                                                              |
